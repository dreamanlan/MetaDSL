...
set ANDROID_CMAKE=C:\Users\dreamanlan\AppData\Local\Android\Sdk\cmake\3.31.5\bin\cmake.exe
set ANDROID_NINJA=C:\Users\dreamanlan\AppData\Local\Android\Sdk\cmake\3.31.5\bin\ninja.exe

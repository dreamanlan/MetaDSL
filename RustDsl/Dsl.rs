...
namespace Dsl
{
    pub delegate void DslLogDelegation(string msg);
    ...
    /// </remarks>
    pub interface ISyntaxComponent
    {
        bool IsValid();
        string GetId();
        int GetIdType();
    ...
    pub abstract class AbstractSyntaxComponent : ISyntaxComponent
    {
        pub const int ID_TOKEN = 0;
        pub const int NUM_TOKEN = 1;
        pub const int STRING_TOKEN = 2;
        pub const int DOLLAR_STRING_TOKEN = 3;
        pub const int MAX_TYPE = 3;

        pub const int SEPARATOR_NOTHING = 0;
        pub const int SEPARATOR_COMMA = 1;
        pub const int SEPARATOR_SEMICOLON = 2;

        pub abstract bool IsValid();
        pub abstract string GetId();
        pub abstract int GetIdType();
        pub abstract int GetLine();
        pub abstract string ToScriptString(bool includeComment);
        pub abstract bool HaveId();

        pub void SetSeparator(int sep)
        {
            m_Separator = sep;
        }
        pub int GetSeparator()
        {
            return m_Separator;
        }
        pub char GetSepChar()
        ...
        pub void CopyComments(ISyntaxComponent other)
        {
            CopyFirstComments(other);
            CopyLastComments(other);
        }
        pub void CopyFirstComments(ISyntaxComponent other)
        {
            if (DslFile.DontLoadComments)
                return;
        ...
        pub void CopyLastComments(ISyntaxComponent other)
        {
            if (DslFile.DontLoadComments)
                return;
        ...
        pub bool FirstCommentOnNewLine {
            get {
                if (DslFile.DontLoadComments)
                    return false;
                var cmtsInfo = GetCommentsInfo();
        ...
        pub static ISyntaxComponent NullSyntax {
            get {
                return s_NullSyntax;
            }
        }
        pub static List<string> EmptyStringList {
            get {
                s_StringList.Clear();
                return s_StringList;
            }
    ...
    pub abstract class ValueOrFunctionData : AbstractSyntaxComponent
    {
        pub bool IsValue {
        ...
        pub ValueData AsValue {
            get { return this as ValueData; }
        }
        pub FunctionData AsFunction {
    ...
    /// </summary>
    pub class ValueData : ValueOrFunctionData
    {
        pub override bool IsValid()
        {
            return HaveId();
        }
        pub override string GetId()
        {
            return m_Id;
        }
        pub override int GetIdType()
        {
            return m_Type;
        }
        pub override int GetLine()
        {
            return m_Line;
        }
        pub override string ToScriptString(bool includeComment)
        {
#if FULL_VERSION
            if (includeComment) {
      ...
      return ToString();
        ...
        pub override bool HaveId()
        {
            return !string.IsNullOrEmpty(m_Id) || m_Type == STRING_TOKEN;
        }

        pub void SetId(string id)
        {
            m_Id = id;
        }
        pub void SetType(int _type)
        {
            m_Type = _type;
        }
        pub void SetLine(int line)
        {
            m_Line = line;
        }
        pub bool IsId()
        ...
        pub void CopyFrom(ValueData other)
        {
            m_Type = other.m_Type;
            m_Id = other.m_Id;
            m_Line = other.m_Line;
        ...
        pub ValueData(string val, int _type)
        {
            m_Type = _type;
            m_Id = val;
            m_Line = -1;
        ...
        pub static ValueData NullValue {
            get {
                s_Instance.Clear();
                return s_Instance;
            }
    ...
    /// </summary>
    pub class FunctionData : ValueOrFunctionData
    {
        pub enum ParamClassEnum
        {
            PARAM_CLASS_MIN = 0,
      ...
      return ToString();
        ...
        pub List<ISyntaxComponent> Params {
            get {
                PrepareParams();
                return m_Params;
            }
        ...
        pub FunctionData LowerOrderFunction {
            get {
        ...
        pub FunctionData ThisOrLowerOrderCall {
            get {
                if (HaveParam())
                    return this;
        ...
        pub FunctionData ThisOrLowerOrderBody {
            get {
                if (HaveStatement())
                    return this;
        ...
        pub FunctionData ThisOrLowerOrderScript {
            get {
                if (HaveExternScript())
                    return this;
        ...
        pub bool HaveLowerOrderStatement()
        {
        ...
        pub bool HaveLowerOrderExternScript()
        {
        ...
        pub void SetParamClass(int type)
        {
        ...
        pub int GetParamClass()
        {
            return m_ParamClass;
        }
        pub int GetParamClassUnmasked()
        {
            int paramClass = (m_ParamClass & (int)ParamClassEnum.PARAM_CLASS_UNMASK);
            return paramClass;
        }
        pub bool HaveParamClassInfixFlag()
        {
        ...
        pub void SetParam(int index, ISyntaxComponent data)
        {
            if (null == m_Params)
                return;
        ...
        pub ISyntaxComponent GetParam(int index)
        {
            if (null == m_Params)
                return NullSyntax;
        ...
        pub string GetParamId(int index)
        {
            if (null == m_Params)
                return string.Empty;
            if (index < 0 || index >= (int)m_Params.Count)
        ...
        pub void ClearParams()
        {
            PrepareParams();
            m_Params.Clear();
        }
        pub void AddParam(string id)
        {
            PrepareParams();
        ...
        pub void AddParam(string id, int type)
        {
            PrepareParams();
        ...
        pub void AddParam(ValueData param)
        {
            PrepareParams();
            m_Params.Add(param);
            if ((int)ParamClassEnum.PARAM_CLASS_NOTHING == m_ParamClass) {
        ...
        pub void AddParam(FunctionData param)
        {
            PrepareParams();
            m_Params.Add(param);
            if ((int)ParamClassEnum.PARAM_CLASS_NOTHING == m_ParamClass) {
        ...
        pub void AddParam(StatementData param)
        {
            PrepareParams();
            m_Params.Add(param);
            if ((int)ParamClassEnum.PARAM_CLASS_NOTHING == m_ParamClass) {
        ...
        pub void AddParam(ISyntaxComponent param)
        {
            PrepareParams();
            m_Params.Add(param);
            if ((int)ParamClassEnum.PARAM_CLASS_NOTHING == m_ParamClass) {
        ...
        pub void CopyFrom(FunctionData other)
        {
        ...
        pub static FunctionData NullFunction {
            get {
                s_Instance.Clear();
                return s_Instance;
            }
    ...
    /// </remarks>
    pub class StatementData : AbstractSyntaxComponent
    {
        pub override bool IsValid()
        {
            bool ret = true;
      ...
      return ToString();
        ...
        pub int GetFunctionNum()
        {
            if (null == m_ValueOrFunctions)
                return 0;
            return m_ValueOrFunctions.Count;
        }
        pub void SetFunction(int index, ValueOrFunctionData funcData)
        {
            if (null == m_ValueOrFunctions || index < 0 || index >= m_ValueOrFunctions.Count)
                return;
            m_ValueOrFunctions[index] = funcData;
        }
        pub ValueOrFunctionData GetFunction(int index)
        {
            if (null == m_ValueOrFunctions || index < 0 || index >= m_ValueOrFunctions.Count)
                return FunctionData.NullFunction;
            return m_ValueOrFunctions[index];
        }
        pub string GetFunctionId(int index)
        {
            if (null == m_ValueOrFunctions || index < 0 || index >= m_ValueOrFunctions.Count)
                return string.Empty;
            return m_ValueOrFunctions[index].GetId();
        }
        pub void AddFunction(ValueOrFunctionData funcData)
        {
            PrepareValueOrFunctions();
            m_ValueOrFunctions.Add(funcData);
        }
        pub List<ValueOrFunctionData> Functions {
            get {
                PrepareValueOrFunctions();
                return m_ValueOrFunctions;
            }
        }
        pub ValueOrFunctionData First {
            get {
                if (null != m_ValueOrFunctions && m_ValueOrFunctions.Count > 0)
        ...
        pub ValueOrFunctionData Second {
            get {
        ...
        pub void CopyFrom(StatementData other)
        {
        ...
        pub static StatementData NullStatement {
            get {
    ...
    pub class DslFile
    {
        pub List<ISyntaxComponent> DslInfos {
            get { return mDslInfos; }
        }
        pub void AddDslInfo(ISyntaxComponent data)
        {
            mDslInfos.Add(data);
        }

        pub bool Load(string file, DslLogDelegation logCallback)
        {
            string content = File.ReadAllText(file);
            //logCallback(string.Format("DslFile.Load {0}:\n{1}", file, content));
            return LoadFromString(content, logCallback);
        }
        pub bool LoadFromString(string content, DslLogDelegation logCallback)
        {
        ...
        pub void LoadBinaryFile(string file, List<string> reuseKeyBuffer, List<string> reuseIdBuffer)
        {
            var code = File.ReadAllBytes(file);
            LoadBinaryCode(code, reuseKeyBuffer, reuseIdBuffer);
        }
        pub void LoadBinaryCode(byte[] binaryCode, List<string> reuseKeyBuffer, List<string> reuseIdBuffer)
        {
            mDslInfos.Clear();
            if (null == binaryCode)
                return;
        ...
        pub void SaveBinaryFile(string file)
        {
#if FULL_VERSION
        ...
        pub bool LoadLua(string file, DslLogDelegation logCallback)
        {
            string content = File.ReadAllText(file);
            //logCallback(string.Format("DslFile.Load {0}:\n{1}", file, content));
            return LoadLuaFromString(content, logCallback);
        }
        pub bool LoadLuaFromString(string content, DslLogDelegation logCallback)
        {
            content = Mac2Unix(content);
        ...
        pub bool LoadCpp(string file, DslLogDelegation logCallback)
        {
            string content = File.ReadAllText(file);
            //logCallback(string.Format("DslFile.Load {0}:\n{1}", file, content));
            return LoadCppFromString(content, logCallback);
        }
        pub bool LoadCppFromString(string content, DslLogDelegation logCallback)
        {
            content = Mac2Unix(content);
        ...
        pub bool LoadGpp(string file, DslLogDelegation logCallback)
        {
            string dummy;
            return LoadGpp(file, logCallback, string.Empty, string.Empty, out dummy);
        }
        pub bool LoadGpp(string file, DslLogDelegation logCallback, string beginDelim, string endDelim)
        {
            string dummy;
            return LoadGpp(file, logCallback, beginDelim, endDelim, out dummy);
        }
        pub bool LoadGpp(string file, DslLogDelegation logCallback, string beginDelim, string endDelim, out string transformedContent)
        {
            string content = File.ReadAllText(file);
            //logCallback(string.Format("DslFile.Load {0}:\n{1}", file, content));
            return LoadGppFromString(content, logCallback, beginDelim, endDelim, out transformedContent);
        }
        pub bool LoadGppFromString(string content, DslLogDelegation logCallback)
        {
            string dummy;
            return LoadGppFromString(content, logCallback, string.Empty, string.Empty, out dummy);
        }
        pub bool LoadGppFromString(string content, DslLogDelegation logCallback, string beginDelim, string endDelim)
        {
            string dummy;
            return LoadGppFromString(content, logCallback, beginDelim, endDelim, out dummy);
        }
        pub bool LoadGppFromString(string content, DslLogDelegation logCallback, string beginDelim, string endDelim, out string transformedContent)
        {
            content = Mac2Unix(content);
        ...
        pub void SetNameTags(Dictionary<string, uint> tags)
        {
            mNameTags = tags;
        }
        pub Dictionary<string, uint> NameTags
        { get { return mNameTags; } }
        pub void SetStringDelimiter(string begin, string end)
        {
            mStringBeginDelimiter = begin;
            mStringEndDelimiter = end;
        }
        pub void SetScriptDelimiter(string begin, string end)
        {
            mScriptBeginDelimiter = begin;
            mScriptEndDelimiter = end;
        }
        pub bool NullableSyntaxEnabled
        {
            set { mNullableSyntaxEnabled = value; }
            get { return mNullableSyntaxEnabled; }
        }
        pub string StringBeginDelimiter {
            get { return mStringBeginDelimiter; }
        }
        pub string StringEndDelimiter {
            get { return mStringEndDelimiter; }
        }
        pub string ScriptBeginDelimiter {
            get { return mScriptBeginDelimiter; }
        }
        pub string ScriptEndDelimiter {
            get { return mScriptEndDelimiter; }
        }
        pub Dsl.Common.TokenCanEatCharDelegation onTokenCanEatChar {
            get { return mOnTokenCanEatChar; }
            set { mOnTokenCanEatChar = value; }
        }
        pub Dsl.Common.GetCppTokenDelegation onGetCppToken {
            get { return mOnGetCppToken; }
            set { mOnGetCppToken = value; }
        }
        pub Dsl.Common.GetTokenDelegation onGetToken {
            get { return mOnGetToken; }
            set { mOnGetToken = value; }
        }
        pub Dsl.Common.BeforeAddFunctionDelegation onBeforeAddFunction {
            get { return mOnBeforeAddFunction; }
            set { mOnBeforeAddFunction = value; }
        }
        pub Dsl.Common.AddFunctionDelegation onAddFunction {
            get { return mOnAddFunction; }
            set { mOnAddFunction = value; }
        }
        pub Dsl.Common.BeforeEndStatementDelegation onBeforeEndStatement {
            get { return mOnBeforeEndStatement; }
            set { mOnBeforeEndStatement = value; }
        }
        pub Dsl.Common.EndStatementDelegation onEndStatement {
            get { return mOnEndStatement; }
            set { mOnEndStatement = value; }
        }
        pub Dsl.Common.BeforeBuildOperatorDelegation onBeforeBuildOperator {
            get { return mOnBeforeBuildOperator; }
            set { mOnBeforeBuildOperator = value; }
        }
        pub Dsl.Common.BuildOperatorDelegation onBuildOperator {
            get { return mOnBuildOperator; }
            set { mOnBuildOperator = value; }
        }
        pub Dsl.Common.SetFunctionIdDelegation onSetFunctionId {
            get { return mOnSetFunctionId; }
            set { mOnSetFunctionId = value; }
        }
        pub Dsl.Common.BeforeBuildHighOrderDelegation onBeforeBuildHighOrder {
            get { return mOnBeforeBuildHighOrder; }
            set { mOnBeforeBuildHighOrder = value; }
        }
        pub Dsl.Common.BuildHighOrderDelegation onBuildHighOrder {
        ...
        {
            pub int Compare(string x, string y)
            {
        ...
        private Dsl.Common.TokenCanEatCharDelegation mOnTokenCanEatChar;
        ...
        pub static byte[] BinaryIdentity {
            get {
        ...
        pub static bool DontLoadComments {
            get {
        ...
        pub static bool IsBinaryDsl(byte[] data, int start)
        {
        ...
        pub static string Mac2Unix(string txt)
        {
        ...
        pub static string Text2Dos(string txt)
        {
            int ix = txt.IndexOf('\n');
            if (ix > 0) {
                if (txt[ix - 1] != '\r')
        ...
        pub static string Text2Unix(string txt)
        {
            int ix = txt.IndexOf('\r');
            if (ix >= 0) {
        ...
        pub static string Text2Mac(string txt)
        {
            int ix = txt.IndexOf('\n');
            if (ix > 0) {
                if (txt[ix - 1] != '\r')
    ...
    pub sealed class DelimiterInfo
    {
        ...
        pub DelimiterInfo() { }
        pub DelimiterInfo(string strBeginDelim, string strEndDelim, string scpBeginDelim, string scpEndDelim)
        {
    ...
    pub sealed class Utility
    {
        pub static string CheckCppParseTable()
        {
        ...
        pub static Dsl.ISyntaxComponent CloneDsl(Dsl.ISyntaxComponent syntax)
        {
        ...
        pub static void writeSyntaxComponent(StringBuilder stream, ISyntaxComponent data, int indent, bool firstLineNoIndent, bool isLastOfStatement, DelimiterInfo delim)
        {
#if FULL_VERSION
        ...
        pub static void writeValueData(StringBuilder stream, ValueData data, int indent, bool firstLineNoIndent, bool isLastOfStatement)
        {
#if FULL_VERSION
        ...
        pub static void writeFunctionData(StringBuilder stream, FunctionData data, int indent, bool firstLineNoIndent, bool isLastOfStatement, DelimiterInfo delim)
        {
#if FULL_VERSION
        ...
        pub static void writeStatementData(StringBuilder stream, StatementData data, int indent, bool firstLineNoIndent, bool isLastOfStatement, DelimiterInfo delim)
        {
#if FULL_VERSION
            writeFirstComments(stream, data, indent, firstLineNoIndent);
    ...
    {
        pub void Visit(short[] production, int[] production_row, short[] parse, int[] parse_row, short start_symbol, short start_action)
        {

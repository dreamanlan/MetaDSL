...
private const short   START_ACTION = 144;
private const short   END_ACTION = 177;

pub static string  GetSymbolName ( short symbol )
{
...
pub static string  GetProductionName ( short production_number )
{

...
namespace Dsl.Common
{
    pub struct DslToken
    {
        ...
        pub void setCurToken(string tok)
        {
            mCurToken = tok;
        }
        pub void setLastToken(string tok)
        {
            mLastToken = tok;
        }
        pub bool enqueueToken(string tok, short val, int line)
        {
            mTokenQueue.Enqueue(new TokenInfo { Token = tok, TokenValue = val, LineNumber = line });
            return true;
        }

        pub string getCurToken()
        {
            return mCurToken;
        }
        pub string getLastToken()
        {
            return mLastToken;
        }
        pub int getLineNumber()
        {
            return mLineNumber;
        }
        pub int getLastLineNumber()
        {
        ...
        pub short getOperatorTokenValue()
        {
        ...
        pub bool isNotIdentifier(char c)
        {
            if (0 == c)
                return false;
            else
        ...
        pub bool isNotIdentifierAndBeginParenthesis(char c)
        {
            if (0 == c)
                return false;
            else
        ...
        pub bool isNotIdentifierAndNumberAndEndParenthesis(char c)
        {
            if (0 == c)
                return false;
            else
        ...
        pub bool isBeginParentheses(char c)
        {
            if (0 == c)
                return false;
            else
        ...
        pub bool isEndParentheses(char c)
        {
            if (0 == c)
                return false;
            else
        ...
        pub char PeekNextValidChar(int beginIndex)
        {
            int _;
            return PeekNextValidChar(beginIndex, out _);
        }
        pub char PeekNextValidChar(int beginIndex, out int index)
        {
            char nextChar = '\0';
            index = -1;
        ...
        pub static bool myisdigit(char c, bool isHex)
        {
            return myisdigit(c, isHex, false, false);
        }
        pub static bool myisdigit(char c, bool isHex, bool includeEPart, bool includeAddSub)
        {
            bool ret = false;
            if (isHex) {
        ...
        pub static int mychar2int(char c)
        {
            if (c >= '0' && c <= '9')
                return c - '0';
            else if (c >= 'a' && c <= 'f')

@@include("<Alembic/AbcCoreAbstract/All.h>")@@include("<Alembic/AbcCoreHDF5/All.h>")@@include("<Alembic/Util/All.h>")@@include("<Alembic/AbcCoreAbstract/Tests/Assert.h>")@@include("<iostream>")@@include("<vector>")@@include("<hdf5.h>")namespace A5 "=" Alembic "::" AbcCoreHDF5;
...
void testDuplicateArray()
{
	...
	
	{
		...
		ABCA "::" ArrayPropertyWriterPtr awp "=" parent "->" createArrayProperty("a", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt16POD, 1), 0);
		ABCA "::" ArrayPropertyWriterPtr bwp "=" parent "->" createArrayProperty("b", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt16POD, 1), 0);
		ABCA "::" ArrayPropertyWriterPtr cwp "=" parent "->" createArrayProperty("c", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt8POD, 1), 0);
...
void testReadWriteArrays()
{
	...
	
	{
		...
		
		{
			...
			TESTING_ASSERT_THROW(props "->" createArrayProperty("/slashy", ABCA "::" MetaData(), dtype, 0), Alembic "::" Util "::" Exception);
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kBooleanPOD, 1);
			ABCA "::" ArrayPropertyWriterPtr boolWrtPtr "=" props "->" createArrayProperty("bool", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" bool_t ">" vals(3);
			vals[0]"=" false;
			vals[1]"=" true;
			vals[2]"=" false;
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			boolWrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kUint8POD, 1);
			ABCA "::" ArrayPropertyWriterPtr uint8WrtPtr "=" props "->" createArrayProperty("uint8", ABCA "::" MetaData(), dtype, 0);
			...
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			uint8WrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
			TESTING_ASSERT(uint8WrtPtr "->" getNumSamples()"==" 1);
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kUint8POD, 1);
			ABCA "::" ArrayPropertyWriterPtr uint8WrtPtr "=" props "->" createArrayProperty("uint8_newDims", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" uint8_t ">" vals(4);
			vals[0]"=" 200;
			vals[1]"=" 45;
			vals[2]"=" 37;
		...
		}
		{
			...
			ABCA "::" ArrayPropertyWriterPtr charWrtPtr "=" props "->" createArrayProperty("int8", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" int8_t ">" vals(2);
			vals[0]"=" "-" 20;
			vals[1]"=" 45;
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			charWrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kUint16POD, 1);
			ABCA "::" ArrayPropertyWriterPtr uint16WrtPtr "=" props "->" createArrayProperty("uint16", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kUint16POD, 1), 0);
			std "::" vector "<" Alembic "::" Util "::" uint16_t ">" vals(3);
			vals[0]"=" 60000;
			vals[1]"=" 2;
			vals[2]"=" 3987;
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			uint16WrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kInt16POD, 1);
			ABCA "::" ArrayPropertyWriterPtr int16WrtPtr "=" props "->" createArrayProperty("int16", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" int16_t ">" vals(2);
			vals[0]"=" "-" 20000;
			vals[1]"=" 77;
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			int16WrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kUint32POD, 1);
			ABCA "::" ArrayPropertyWriterPtr uint32WrtPtr "=" props "->" createArrayProperty("uint32", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" uint32_t ">" vals(1);
			vals[0]"=" 1000000;
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			uint32WrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kInt32POD, 1);
			ABCA "::" ArrayPropertyWriterPtr int32WrtPtr "=" props "->" createArrayProperty("int32", ABCA "::" MetaData(), dtype, 0);
			...
			vals[3]"=" 123456;
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			int32WrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kUint64POD, 1);
			ABCA "::" ArrayPropertyWriterPtr ui64WrtPtr "=" props "->" createArrayProperty("uint64", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" uint64_t ">" vals(3);
			vals[0]"=" 5000000000LL;
			vals[1]"=" 1234567891011LL;
			vals[2]"=" 12;
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			ui64WrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kInt64POD, 1);
			ABCA "::" ArrayPropertyWriterPtr i64WrtPtr "=" props "->" createArrayProperty("int64", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" int64_t ">" vals(2);
			vals[0]"=" "-" 5000000000LL;
			vals[1]"=" 9876543210LL;
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			i64WrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kFloat16POD, 1);
			ABCA "::" ArrayPropertyWriterPtr halfWrtPtr "=" props "->" createArrayProperty("float16", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" float16_t ">" vals(2);
			vals[0]"=" 16.0;
			vals[1]"=" "-" 3.0;
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			halfWrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kFloat32POD, 2);
			ABCA "::" ArrayPropertyWriterPtr floatWrtPtr "=" props "->" createArrayProperty("float32", ABCA "::" MetaData(), dtype, 0);
			...
			floatWrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kFloat32POD, 1);
			ABCA "::" ArrayPropertyWriterPtr floatWrtPtr "=" props "->" createArrayProperty("float32_ext1", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" float32_t ">" vals(4);
			vals[0]"=" 128.0;
			vals[1]"=" "-" 13.25;
			vals[2]"=" 35.5;
		...
		}
		{
			...
			ABCA "::" ArrayPropertyWriterPtr doubleWrtPtr "=" props "->" createArrayProperty("float64", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" float64_t ">" vals(30);
			for(size_t i "=" 0, i "<" vals "." size(), "++" i)vals[i]"=" i "*" 100.0;
			TESTING_ASSERT(doubleWrtPtr "->" getNumSamples()"==" 0);
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			doubleWrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
			TESTING_ASSERT(doubleWrtPtr "->" getNumSamples()"==" 1);
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kFloat64POD, 3);
			ABCA "::" ArrayPropertyWriterPtr doubleWrtPtr "=" props "->" createArrayProperty("float64_ext3", ABCA "::" MetaData(), dtype, 0);
			std "::" vector "<" Alembic "::" Util "::" float64_t ">" vals(30);
			for(size_t i "=" 0, i "<" vals "." size(), "++" i)vals[i]"=" i "*" 100.0;
			TESTING_ASSERT(doubleWrtPtr "->" getNumSamples()"==" 0);
		...
		}
		{
			...
			ABCA "::" ArrayPropertyWriterPtr strWrtPtr "=" props "->" createArrayProperty("str", ABCA "::" MetaData(), dtype, 0);
			...
			vals[3]"=" "cake!";
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			strWrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		}
		{
			ABCA "::" DataType dtype(Alembic "::" Util "::" kWstringPOD, 1);
			ABCA "::" ArrayPropertyWriterPtr wstrWrtPtr "=" props "->" createArrayProperty("wstr", ABCA "::" MetaData(), dtype, 0);
			...
			vals[3]"=" L "亏 ⺏ 㶏";
			Alembic "::" Util "::" Dimensions dims(vals "." size());
			wstrWrtPtr "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, dims));
		};
	}
	{
		A5 "::" ReadArchive r;
		...
		for(size_t i "=" 0, i "<" parent "->" getNumProperties(), "++" i)
		{
			...
			if(ap "->" getName()"!=" "float64_ext3" "&&" ap "->" getName()"!=" "float32")TESTING_ASSERT(ap "->" getDataType()"." getExtent()"==" 1);
			switch(ap "->" getDataType()"." getPod())
			{
				case Alembic "::" Util "::" kBooleanPOD ":"
				{
					...
					TESTING_ASSERT(key "." digest "." str()"==" "bbde8ffe4b7e061c7e03081c2bf184c4");
				};
				break;
				case Alembic "::" Util "::" kUint8POD ":"
				{
					TESTING_ASSERT(ap "->" getName()"==" "uint8" "||" ap "->" getName()"==" "uint8_newDims");
					TESTING_ASSERT("!" ap "->" isScalarLike());
					ABCA "::" ArraySamplePtr val;
					ap "->" getSample(0, val);
					...
					TESTING_ASSERT(key "." digest "." str()"==" "2972c92c7f534e37ee116ae01c707741");
					if(ap "->" getName()"==" "uint8")
					{
						Dimensions dims0;
						ap "->" getDimensions(0, dims0);
				...
				case Alembic "::" Util "::" kInt32POD ":"
				{
					...
					ap "->" getAs(0, data2, kInt16POD);
					TESTING_ASSERT(data2[0]"==" "-" 32768);
					TESTING_ASSERT(data2[1]"==" 42);
					TESTING_ASSERT(data2[2]"==" "-" 20000);
					TESTING_ASSERT(data2[3]"==" 32767);
					...
					TESTING_ASSERT_THROW(ap "->" getAs(0, data3, kStringPOD), Alembic "::" Util "::" Exception);
					TESTING_ASSERT_THROW(ap "->" getAs(0, data3, kWstringPOD), Alembic "::" Util "::" Exception);
					TESTING_ASSERT(data3[0]"==" "-" 1000000);
					TESTING_ASSERT(data3[1]"==" 42);
					TESTING_ASSERT(data3[2]"==" "-" 20000);
					TESTING_ASSERT(data3[3]"==" 123456);
				...
				case Alembic "::" Util "::" kUint64POD ":"
				{
					...
					TESTING_ASSERT(dims0 "." rank()"==" 1);
					TESTING_ASSERT(dims0 "." numPoints()"==" 3);
					Alembic "::" Util "::" uint64_t "*" data "="(Alembic "::" Util "::" uint64_t "*")(val "->" getData());
					...
					ap "->" getAs(0, data2, kInt16POD);
					TESTING_ASSERT(data2[0]"==" 32767);
					TESTING_ASSERT(data2[1]"==" 32767);
				...
				case Alembic "::" Util "::" kInt64POD ":"
				{
					...
					TESTING_ASSERT(dims0 "." rank()"==" 1);
					TESTING_ASSERT(dims0 "." numPoints()"==" 2);
					Alembic "::" Util "::" int64_t "*" data "="(Alembic "::" Util "::" int64_t "*")(val "->" getData());
					TESTING_ASSERT(data[0]"==" "-" 5000000000LL);
				...
				case Alembic "::" Util "::" kFloat16POD ":"
				{
					...
					TESTING_ASSERT_THROW(ap "->" getAs(0, data2, kFloat32POD), Alembic "::" Util "::" Exception);
				...
				{
					TESTING_ASSERT(ap "->" getName()"==" "float32" "||" ap "->" getName()"==" "float32_ext1");
					TESTING_ASSERT("!" ap "->" isScalarLike());
					ABCA "::" ArraySamplePtr val;
					ap "->" getSample(0, val);
					ABCA "::" ArraySampleKey key;
					...
					TESTING_ASSERT_THROW(ap "->" getAs(0, data4, kStringPOD), Alembic "::" Util "::" Exception);
					TESTING_ASSERT_THROW(ap "->" getAs(0, data4, kWstringPOD), Alembic "::" Util "::" Exception);
					TESTING_ASSERT(data4[0]"==" 128);
					TESTING_ASSERT(data4[1]"==" "-" 13);
					TESTING_ASSERT(data4[2]"==" 35);
					TESTING_ASSERT(data4[3]"==" 128);
				...
				{
					TESTING_ASSERT(ap "->" getName()"==" "float64" "||" ap "->" getName()"==" "float64_ext3");
					TESTING_ASSERT("!" ap "->" isScalarLike());
					ABCA "::" ArraySamplePtr val;
					ap "->" getSample(0, val);
					TESTING_ASSERT(val "->" getDimensions()"." rank()"==" 1);
					...
					Alembic "::" Util "::" float64_t "*" data "="(Alembic "::" Util "::" float64_t "*")(val "->" getData());
				...
				case Alembic "::" Util "::" kStringPOD ":"
				{
					...
					Alembic "::" Util "::" int32_t data3[4];
					TESTING_ASSERT_THROW(ap "->" getAs(0, data3, kInt32POD), Alembic "::" Util "::" Exception);
				};
				break;
...
void testEmptyArray()
{
	...
	
	{
		...
		ABCA "::" ObjectWriterPtr archive "=" a "->" getTop();
		ABCA "::" CompoundPropertyWriterPtr parent "=" archive "->" getProperties();
		ABCA "::" ArrayPropertyWriterPtr awp "=" parent "->" createArrayProperty("emptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt32POD, 1), 0);
	...
	}
	{
		...
		ABCA "::" ObjectWriterPtr archive "=" a "->" getTop();
		ABCA "::" CompoundPropertyWriterPtr parent "=" archive "->" getProperties();
		TESTING_ASSERT_THROW(parent "->" createArrayProperty("emptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt32POD, 0), 0), Alembic "::" Util "::" Exception);
		TESTING_ASSERT_THROW(parent "->" createArrayProperty("emptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kUnknownPOD, 1), 0), Alembic "::" Util "::" Exception);
		TESTING_ASSERT_THROW(parent "->" createArrayProperty("emptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kNumPlainOldDataTypes, 1), 0), Alembic "::" Util "::" Exception);
		TESTING_ASSERT_THROW(parent "->" createArrayProperty("emptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt32POD, 1), 45), Alembic "::" Util "::" Exception);
		TESTING_ASSERT_THROW(parent "->" createScalarProperty("emptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt32POD, 0), 0), Alembic "::" Util "::" Exception);
		TESTING_ASSERT_THROW(parent "->" createScalarProperty("emptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kUnknownPOD, 1), 0), Alembic "::" Util "::" Exception);
		TESTING_ASSERT_THROW(parent "->" createScalarProperty("emptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kNumPlainOldDataTypes, 1), 0), Alembic "::" Util "::" Exception);
		TESTING_ASSERT_THROW(parent "->" createScalarProperty("emptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt32POD, 1), 42), Alembic "::" Util "::" Exception);
		parent "->" createArrayProperty("veryEmptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt32POD, 1), 0);
		TESTING_ASSERT_THROW(parent "->" createScalarProperty("veryEmptyInt32", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt32POD, 1), 0), Alembic "::" Util "::" Exception);
		ABCA "::" ArrayPropertyWriterPtr ap "=" parent "->" createArrayProperty("emptyInt64", ABCA "::" MetaData(), ABCA "::" DataType(Alembic "::" Util "::" kInt64POD, 1), 0);
		ABCA "::" Dimensions zeroLengthDims;
		zeroLengthDims "." setRank(1);
		zeroLengthDims[0]"=" 0;
		ABCA "::" ArraySample samp(NULL, ABCA "::" DataType(Alembic "::" Util "::" kInt64POD, 1), zeroLengthDims);
		ap "->" setSample(samp);
	}
	{
		A5 "::" ReadArchive r;
		...
		for(size_t i "=" 0, i "<" parent "->" getNumProperties(), "++" i)
		{
			...
			else if(ap "->" getName()"==" "emptyInt64")
			{
				...
				TESTING_ASSERT(key "." digest "." str()"==" "00000000000000000000000000000000");
			};
		};
	};
};
void testExtentArrayStrings()
{
	...
	
	{
		...
		ABCA "::" ArrayPropertyWriterPtr awp "=" parent "->" createArrayProperty("str", ABCA "::" MetaData(), dtype, 0);
		...
		vals4[4]"=" "e";
		vals4[5]"=" "f";
		awp "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, Alembic "::" Util "::" Dimensions(3)));
		awp "->" setSample(ABCA "::" ArraySample("&"(vals2 "." front()), dtype, Alembic "::" Util "::" Dimensions(2)));
		std "::" vector "<" Alembic "::" Util "::" string ">" badVals(1);
		badVals[0]"=" "This better fail.";
		TESTING_ASSERT_THROW(awp "->" setSample(ABCA "::" ArraySample("&"(badVals "." front()), ABCA "::" DataType(Alembic "::" Util "::" kStringPOD, 1), Alembic "::" Util "::" Dimensions(1))), Alembic "::" Util "::" Exception);
		awp "->" setSample(ABCA "::" ArraySample("&"(vals3 "." front()), dtype, Alembic "::" Util "::" Dimensions(2)));
		awp "->" setSample(ABCA "::" ArraySample("&"(vals2 "." front()), dtype, Alembic "::" Util "::" Dimensions(2)));
		awp "->" setSample(ABCA "::" ArraySample("&"(vals4 "." front()), dtype, Alembic "::" Util "::" Dimensions(3)));
		std "::" vector "<" Alembic "::" Util "::" float32_t ">" vals5(3);
		vals5[0]"=" 1.0;
		vals5[1]"=" 2.0;
		vals5[2]"=" 3.0;
		TESTING_ASSERT_THROW(awp "->" setSample(ABCA "::" ArraySample("&"(vals5 "." front()), ABCA "::" DataType(Alembic "::" Util "::" kFloat32POD, 1), Alembic "::" Util "::" Dimensions(3))), Alembic "::" Util "::" Exception);
	}
	{
		A5 "::" ReadArchive r;
		ABCA "::" ArchiveReaderPtr a "=" r(archiveName);
		...
		TESTING_ASSERT(key "." digest "." str()"==" "88d5ea1d772131992c9be9a192938df7");
		ap "->" getSample(1, val);
		TESTING_ASSERT(val "->" getDimensions()"." numPoints()"==" 2);
		TESTING_ASSERT(val "->" getDimensions()"." rank()"==" 1);
		...
		TESTING_ASSERT(key "." origPOD "==" Alembic "::" Util "::" kStringPOD);
		TESTING_ASSERT(key "." readPOD "==" Alembic "::" Util "::" kStringPOD);
		TESTING_ASSERT(key "." digest "." str()"==" "126ebab40166a642d3c8cc4c5929074d");
		ap "->" getSample(2, val);
		TESTING_ASSERT(val "->" getDimensions()"." numPoints()"==" 2);
		TESTING_ASSERT(val "->" getDimensions()"." rank()"==" 1);
		...
		TESTING_ASSERT(key "." origPOD "==" Alembic "::" Util "::" kStringPOD);
		TESTING_ASSERT(key "." readPOD "==" Alembic "::" Util "::" kStringPOD);
		TESTING_ASSERT(key "." digest "." str()"==" "a197a3747b0666dfacdc17634f5cabff");
		ap "->" getSample(3, val);
...
void testArrayStringsRepeats()
{
	...
	
	{
		...
		ABCA "::" CompoundPropertyWriterPtr parent "=" archive "->" getProperties();
		ABCA "::" ArrayPropertyWriterPtr awp "=" parent "->" createArrayProperty("str", ABCA "::" MetaData(), dtype, 0);
		awp "->" setSample(ABCA "::" ArraySample("&"(valsEmpty "." front()), dtype, Alembic "::" Util "::" Dimensions(valsEmpty "." size())));
		awp "->" setSample(ABCA "::" ArraySample("&"(valsEmpty "." front()), dtype, Alembic "::" Util "::" Dimensions(valsEmpty "." size())));
		awp "->" setSample(ABCA "::" ArraySample("&"(valsEmpty "." front()), dtype, Alembic "::" Util "::" Dimensions(valsEmpty "." size())));
		awp "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, Alembic "::" Util "::" Dimensions(vals "." size())));
		awp "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, Alembic "::" Util "::" Dimensions(vals "." size())));
		awp "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, Alembic "::" Util "::" Dimensions(vals "." size())));
		awp "->" setSample(ABCA "::" ArraySample("&"(vals2 "." front()), dtype, Alembic "::" Util "::" Dimensions(vals2 "." size())));
		awp "->" setSample(ABCA "::" ArraySample("&"(vals2 "." front()), dtype, Alembic "::" Util "::" Dimensions(vals2 "." size())));
		awp "->" setSample(ABCA "::" ArraySample("&"(valsEmpty "." front()), dtype, Alembic "::" Util "::" Dimensions(valsEmpty "." size())));
		awp "->" setSample(ABCA "::" ArraySample("&"(valsEmpty "." front()), dtype, Alembic "::" Util "::" Dimensions(valsEmpty "." size())));
		dtype "." setExtent(2);
		ABCA "::" ArrayPropertyWriterPtr awp2 "=" parent "->" createArrayProperty("str2", ABCA "::" MetaData(), dtype, 0);
		awp2 "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, Alembic "::" Util "::" Dimensions(vals "." size()"/" 2)));
		awp2 "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, Alembic "::" Util "::" Dimensions(vals "." size()"/" 2)));
		awp2 "->" setSample(ABCA "::" ArraySample("&"(vals "." front()), dtype, Alembic "::" Util "::" Dimensions(vals "." size()"/" 2)));
		awp2 "->" setSample(ABCA "::" ArraySample(NULL, dtype, Alembic "::" Util "::" Dimensions(0)));
		awp2 "->" setSample(ABCA "::" ArraySample("&"(vals2 "." front()), dtype, Alembic "::" Util "::" Dimensions(vals2 "." size()"/" 2)));
		awp2 "->" setSample(ABCA "::" ArraySample("&"(vals2 "." front()), dtype, Alembic "::" Util "::" Dimensions(vals2 "." size()"/" 2)));
	}
	{
		A5 "::" ReadArchive r;
		ABCA "::" ArchiveReaderPtr a "=" r(archiveName, ABCA "::" ReadArraySampleCachePtr());
		ABCA "::" ObjectReaderPtr archive "=" a "->" getTop();
		ABCA "::" CompoundPropertyReaderPtr parent "=" archive "->" getProperties();
		TESTING_ASSERT(parent "->" getNumProperties()"==" 2);

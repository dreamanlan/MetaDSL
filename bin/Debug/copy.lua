...
lualist(System)assignwith(System or 
{
});
lualist(System.Boolean)assignwith(System.Boolean or get_basic_type_func());
lualist(System.SByte)assignwith(System.SByte or get_basic_type_func());
lualist(System.Byte)assignwith(System.Byte or get_basic_type_func());
lualist(System.Char)assignwith(System.Char or get_basic_type_func());
lualist(System.Int16)assignwith(System.Int16 or get_basic_type_func());
lualist(System.Int32)assignwith(System.Int32 or get_basic_type_func());
lualist(System.Int64)assignwith(System.Int64 or get_basic_type_func());
lualist(System.UInt16)assignwith(System.UInt16 or get_basic_type_func());
lualist(System.UInt32)assignwith(System.UInt32 or get_basic_type_func());
lualist(System.UInt64)assignwith(System.UInt64 or get_basic_type_func());
lualist(System.Single)assignwith(System.Single or get_basic_type_func());
lualist(System.Double)assignwith(System.Double or get_basic_type_func());
lualist(System.String)assignwith(System.String or get_basic_type_func());
lualist(System.Collections)assignwith(System.Collections or 
{
});
lualist(System.Collections.Generic)assignwith(System.Collections.Generic or 
{
});
lualist(System.Collections.Generic.List_T)assignwith(
{
...
lualist(System.Nullable_T)assignwith(System.Nullable_T or 
{
});
lualist(System.Collections.Generic.MyDictionary_TKey_TValue)assignwith(System.Collections.Generic.Dictionary_TKey_TValue or 
{
});
lualist(System.Linq)assignwith(System.Linq or 
{
});
lualist(System.Linq.Enumerable)assignwith(System.Linq.Enumerable or 
{
});
lualist(Cs2LuaList_T)assignwith(Cs2LuaList_T or 
{
});
lualist(Cs2LuaIntDictionary_TValue)assignwith(Cs2LuaIntDictionary_TValue or 
{
});
lualist(Cs2LuaStringDictionary_TValue)assignwith(Cs2LuaStringDictionary_TValue or 
{
});
lualist(__cs2lua_special_integer_operators)assignwith(
{
	/;
	%;
	+;
...
lualist(__cs2lua_add)assignwith(2);
lualist(__cs2lua_sub)assignwith(3);
lualist(__cs2lua_mul)assignwith(4);
lualist(__cs2lua_lshift)assignwith(5);
lualist(__cs2lua_rshift)assignwith(6);
lualist(__cs2lua_bitand)assignwith(7);
lualist(__cs2lua_bitor)assignwith(8);
lualist(__cs2lua_bitxor)assignwith(9);
lualist(__cs2lua_bitnot)assignwith(10);
lualist(SymbolKind)assignwith(
{
	Alias = 0;
	ArrayType = 1;
	Assembly = 2;
...
lualist(g_CsStr2LuaStrCaches)assignwith(
{
});
function(forwardtocsstr)
luaargs(str)
{
	if(str == nil)
	{
...
luaargs(str)
{
	...
	{
		local(lualist(meta)assignwith(getmetatable(str)));
		if(meta and rawget(meta, "__typename") == "String")
		{
			local(lualist(v)assignwith(g_CsStr2LuaStrCaches[str]));
			if(v == nil)
			{
...
luaargs(str)
{
	...
	elseif(type(str) == "string")
	{
		local(lualist(v)assignwith(g_LuaStr2CsStrCaches[str]));
		if(v == nil)
		{
...
luaargs(x)
{
	local(lualist(ret)assignwith(nil));
	if(package.loading[x] == nil)
	{
...
{
	local(lualist(retval)assignwith(nil));
	if( not handled and func)
	{
		lualist(retval)assignwith(func(
		{
			Message = err[1];
			StackTrace = err[2];
			ToString = function()
...
luaargs(arr)
{
	...
	{
		if(type(arr) == "userdata")
		{
			local(lualist(tb)assignwith(
			{
			}));
			for(i)
			luarange(1,  # arr)
...
luaargs(elementType, elementTypeKind, callerClass, obj, class, name, argCount, ...)
{
	...
	if(meta)
	{
		local(lualist(_class)assignwith(rawget(meta, "__class")));
...
luaargs(elementType, elementTypeKind, callerClass, obj, class, name, argCount, ...)
{
	local(lualist(arg1, arg2, arg3)assignwith(...));
	local(index);
	lualist(index)assignwith(__unwrap_if_string(arg1));
	lualist(val)assignwith(arg2);
	if(nil == index)
	{
		UnityEngine.Debug.LogError__Object("[cs2lua] table index is nil");
		return();
...
{
	local(lualist(arg1, arg2)assignwith(...));
	local(lualist(marg1)assignwith(arg1 and getmetatable(arg1)));
	local(lualist(marg2)assignwith(arg2 and getmetatable(arg2)));
	if(rettype == System.Boolean and class == System.Type)
	{
	...
	elseif(method == "op_Implicit" or 1 == string.find(method, "op_Implicit__", 1, true))
	{
		...
		if(class == UnityEngine.Vector4)
		{
			...
			elseif(t == "Vector4")
			{
				if(rettype == UnityEngine.Vector3)
				{
		...
		elseif(class == UnityEngine.Color32)
		{
			...
			{
				local(lualist(c32)assignwith(Color32Pool.Alloc()));
				table.insert(funcInfo.c32_list, c32);
				lualist(c32.x)assignwith(arg1.r * 255);
	...
	elseif(method == "op_Multiply" or 1 == string.find(method, "op_Multiply__", 1, true))
	{
		...
		{
			local(lualist(t1)assignwith(nil));
	...
	elseif(method == "op_Division" or 1 == string.find(method, "op_Division__", 1, true))
	{
		if(arg1 ~= nil and arg2 ~= nil)
		{
			...
			if(t1 == "Vector2" and type(arg2) == "number")
			{
				local(lualist(v2)assignwith(Vector2Pool.Alloc()));
				table.insert(funcInfo.v2_list, v2);
			...
			elseif(t1 == "Vector3" and type(arg2) == "number")
			{
				local(lualist(v3)assignwith(Vector3Pool.Alloc()));
				table.insert(funcInfo.v3_list, v3);
			...
			elseif(t1 == "Vector4" and type(arg2) == "number")
			{
				local(lualist(v4)assignwith(Vector4Pool.Alloc()));
				table.insert(funcInfo.v4_list, v4);
				lualist(v4.x)assignwith(arg1.x / arg2);
			...
			elseif(t1 == "Color" and type(arg2) == "number")
			{
				local(lualist(c)assignwith(ColorPool.Alloc()));
				table.insert(funcInfo.c_list, c);
				lualist(c.x)assignwith(arg1.r / arg2);
...
luaargs(obj, isEnum, class, method, ...)
{
	...
	if(method)
	{
		...
		{
			if(type(obj) == "boolean" and type(arg1) == "boolean")
			{
				if(obj and arg1)
				{
					return(0);
...
{
	if(nil ~= firstArray and nil ~= method)
	{
		local(lualist(arg1, arg2)assignwith(...));
		local(lualist(meta)assignwith(getmetatable(firstArray)));
		if(meta and rawget(meta, "__cs2lua_defined"))
		{
...
luaargs(tag, newFunc)
{
	local(lualist(pool)assignwith(
	{
	}));
	lualist(pool.Alloc)assignwith(function()
	luaargs()
	{
	...
	luaargs(data)
	{
		local(lualist(exists)assignwith(false));
		for(i, v)
		in(ipairs(pool.m_Data))
		{
			if(rawequal(v, data))
			{
...
lualist(g_FuncInfoPool)assignwith(createpool("FuncInfo", function()
luaargs()
{
	return(
	{
...
luaargs(char, intVal)
{
	...
	{
		local(lualist(str)assignwith(tostring(char)));
		local(lualist(l)assignwith(string.len(str)));
		if(l == 1)
		{
...
{
	local(lualist(num)assignwith(select("#", ...)));
	if(num == 1)
	{
...
lualist(Cs2LuaCustomData)assignwith(
{
	...
	luaargs()
	{
		...
		local(lualist(class)assignwith(Cs2LuaCustomData));
...
luaargs(symKind, isStatic, symName, arg1, ...)
{
	if(arg1 and symKind == SymbolKind.Field)
	{
...
luaargs(obj)
{
	if(type(obj) == "table")
	{
		local(lualist(oldTblMeta)assignwith(getmetatable(obj)));
...
luaargs(tb)
{
	local(lualist(count)assignwith(0));
	for(k, v)
	in(pairs(tb))
	{
...
lualist(__mt_index_of_array_table)assignwith(
{
	...
	luaargs(obj, ix)
	{
		local(lualist(ret)assignwith(0));
		local(lualist(tb)assignwith(obj));
		for(i)
		luarange(0, ix)
		{
	...
	luaargs(obj, p)
	{
		local(lualist(pos)assignwith(0));
		local(lualist(ret)assignwith(nil));
	...
	luaargs(obj, pred)
	{
		local(lualist(deletes)assignwith(
		{
		}));
		local(lualist(ct)assignwith(__get_array_count(obj)));
		for(i)
	...
	luaargs(obj, coll)
	{
		local(lualist(iter)assignwith(newiterator(nil, coll)));
		for(v)
		in(getiterator(iter))
		{
			lualist(v)assignwith(__unwrap_if_string(v));
	...
	luaargs(obj, ix, coll)
	{
		local(lualist(ct)assignwith(0));
		local(lualist(enumer)assignwith(coll->GetEnumerator()));
	...
	{
		local(lualist(ct)assignwith(__get_array_count(obj)));
		local(lualist(start)assignwith(0));
		local(lualist(count)assignwith(ct));
		local(lualist(pred)assignwith(p1));
	...
	luaargs(obj, p)
	{
		local(lualist(ret)assignwith(false));
		local(lualist(ct)assignwith(__get_array_count(obj)));
		for(i)
		luarange(1, ct)
		{
	...
	{
		local(lualist(ct)assignwith(__get_array_count(obj)));
		local(lualist(ret)assignwith(wraparray(
		{
		}, ct)));
		for(k)
		luarange(1, ct)
...
lualist(__mt_index_of_dictionary_table)assignwith(
{
	...
	luaargs(obj, p1, p2)
	{
		lualist(up1)assignwith(__unwrap_if_string(p1));
	...
	luaargs(obj, p)
	{
		lualist(up)assignwith(__unwrap_if_string(p));
		local(lualist(data)assignwith(__get_table_data(obj)));
	...
	luaargs(obj, p)
	{
		...
		{
			if(meta.__cs2lua_typekinds[2] == TypeKind.Struct)
			{
...
luaargs(t, k)
{
	...
	else
	{
		...
		{
			lualist(uk)assignwith(__unwrap_if_string(k));
			local(lualist(data)assignwith(__get_table_data(t)));
...
lualist(__mt_index_of_keycollection_table)assignwith(
{
	...
	luaargs(obj, arr)
	{
		local(lualist(t)assignwith(obj.dict));
		local(lualist(data)assignwith(__get_table_data(t)));
		for(k, v)
		in(pairs(data))
		{
...
luaargs(tb)
{
	...
	return(setmetatable(
	{
		...
		luaargs(this)
		{
			local(lualist(ltb)assignwith(this.object));
			local(lualist(num)assignwith(__get_array_count(ltb)));
			if(this.index < num)
			{
...
luaargs(tb)
{
	...
	return(setmetatable(
	{
		...
		{
			local(lualist(ltb)assignwith(this.object));
			local(lualist(v)assignwith(nil));
			local(lualist(data)assignwith(__get_table_data(ltb)));
...
{
	local(lualist(meta)assignwith(getmetatable(exp)));
	if(meta and rawget(meta, "__cs2lua_defined"))
	{
		if(meta.cachedIters and meta.cachedIters[exp] and  # (meta.cachedIters[exp]) > 0)
		{
			local(lualist(iterInfo)assignwith(table.remove(meta.cachedIters[exp], 1)));
			iterInfo[2]->Reset();
			if(funcInfo)
			{
		...
		{
			local(lualist(enumer)assignwith(exp->GetEnumerator()));
			local(lualist(f)assignwith(function()
			luaargs()
			{
				if(enumer->MoveNext())
				{
	...
	elseif(meta and rawget(meta, "__typename") == "LuaArray")
	{
		...
		{
			local(lualist(arr)assignwith(exp));
			local(lualist(curIx)assignwith(0));
			local(lualist(f)assignwith(function()
			luaargs()
			{
				if(curIx < arr.Length)
				{
					lualist(curIx)assignwith(curIx + 1);
	...
	{
		if(meta and meta.cachedIters and meta.cachedIters[exp] and  # (meta.cachedIters[exp]) > 0)
		{
			local(lualist(iterInfo)assignwith(table.remove(meta.cachedIters[exp], 1)));
			iterInfo[1](true);
			if(funcInfo)
...
luaargs(funcInfo, iterInfo)
{
	...
	if(exp)
	{
		...
		if(meta)
		{
			...
			{
				lualist(meta.cachedIters)assignwith(
				{
				});
				lualist(meta.cachedIters[exp])assignwith(
				{
...
{
	local(lualist(arr)assignwith(wraparray(
	{
	}, size1, classObj, typeKind)));
	for(i)
	luarange(1, size1)
	{
...
luaargs(classObj, typeKind, defVal, size1, size2)
{
	...
	luarange(1, size1)
	{
		lualist(arr[i])assignwith(wraparray(
		{
		}, size2, classObj, typeKind));
		for(j)
		luarange(1, size2)
		{
...
luaargs(classObj, typeKind, defVal, size1, size2, size3)
{
	...
	luarange(1, size1)
	{
		...
		luarange(1, size2)
		{
			lualist(arr[i][j])assignwith(wraparray(
			{
			}, size3, classObj, typeKind));
			for(k)
			luarange(1, size3)
			{
...
luaargs(t, typeargs, typekinds, ctor, ctorRetCt, dict, ...)
{
	if(dict)
	{
		...
		{
			local(lualist(iter)assignwith(newiterator(arg1)));
			for(v)
			in(getiterator(iter))
			{
...
luaargs(t, typeargs, typekinds, ctor, ctorRetCt, list, ...)
{
	if(list)
	{
		local(lualist(obj)assignwith(setmetatable(list, 
		{
			__index = __mt_index_of_array;
			__count =  # list;
			__cs2lua_defined = true;
		...
		{
			local(lualist(meta)assignwith(getmetatable(arg1)));
			if(meta and  not rawget(meta, "__cs2lua_defined"))
			{
				local(lualist(typename)assignwith(rawget(meta, "__typename")));
				if(typename == "LuaArray")
				{
					local(lualist(ct)assignwith(arg1.Length));
					for(i)
					luarange(1, ct)
					{
						obj->Add(arg1[i]);
...
luaargs(t, typeargs, typekinds, ctor, ctorRetCt, coll, ...)
{
	...
	elseif(coll)
	{
		local(lualist(obj)assignwith(setmetatable(
		{
		}, 
		{
			__index = __mt_index_of_hashset;
			__cs2lua_defined = true;
			__class = t;
			__cs2lua_data = 
			{
...
luaargs(t, typeargs, typekinds, ctor, ctorRetCt, dict, ...)
{
	...
	{
		local(lualist(obj)assignwith(t[ctor](...)));
		if(obj)
		{
			if(dict ~= nil)
			{
...
lualist(LINQ.exec)assignwith(function()
luaargs(linq)
{
	local(lualist(paramList)assignwith(
	{
	}));
...
{
	local(lualist(finalRs)assignwith(
	{
	}));
	local(lualist(interRs)assignwith(
	{
	}));
	local(lualist(itemNum)assignwith( # linq));
	while(ix <= itemNum)
	{
		local(lualist(v)assignwith(linq[ix]));
		...
		elseif(key == "where")
		{
			local(lualist(temp)assignwith(interRs));
			lualist(interRs)assignwith(
			{
			});
			for(i, val)
			in(ipairs(temp))
...
luaargs(linq, ix, paramList, coll, interRs, finalRs)
{
	...
	in(getiterator(coll))
	{
		...
		local(lualist(newIx)assignwith(ix));
		local(lualist(itemNum)assignwith( # linq));
		while(newIx <= itemNum)
		{
			local(lualist(v)assignwith(linq[newIx]));
			local(lualist(key)assignwith(v[1]));
			if(key == "let")
			{
			...
			elseif(key == "from")
			{
				local(lualist(ts)assignwith(LINQ.execRecursively(linq, newIx, newParamList)));
				for(i, val)
				in(ipairs(ts))
				{
...
luaargs(l1, l2, list)
{
	...
	in(ipairs(list))
	{
		local(lualist(v1)assignwith(v[1](unpack(l1))));
		local(lualist(v2)assignwith(v[1](unpack(l2))));
		local(lualist(asc)assignwith(v[2]));
		if(v1 ~= v2)
		{
			if(asc)
			{
...
luaargs(obj)
{
	...
	if(meta)
	{
		...
		{
			local(lualist(name)assignwith(rawget(meta, "__fullname")));
...
luaargs(obj, t, tk)
{
	...
	local(lualist(tn2)assignwith(getclassfullname(t)));
	if(meta)
	{
		...
		else
		{
			...
			{
				local(lualist(meta3)assignwith(getmetatable(lastCheckedClass)));
				if(meta3)
				{
					lualist(parent)assignwith(rawget(meta3, "__parent"));
					while(parent ~= nil)
					{
						lualist(tn1)assignwith(rawget(parent, "__fullname"));
						if(tn1 and tn1 == tn2)
...
luaargs(k, obj)
{
	local(lualist(t)assignwith(getmetatable(obj)));
	repeat
	{
		local(lualist(fun)assignwith(rawget(t, k)));
...
{
	local(lualist(base_class)assignwith(base));
	local(lualist(class_fields)assignwith(rawget(class, "__class_fields")));
	local(lualist(obj_fields)assignwith(nil));
	local(lualist(obj_field_values)assignwith(nil));
	local(lualist(interfaces)assignwith(rawget(class, "__interfaces")));
	local(lualist(method_info)assignwith(rawget(class, "__method_info")));
	local(lualist(is_sealed_class)assignwith(rawget(class, "__is_sealed_class")));
	local(lualist(is_static_class)assignwith(rawget(class, "__is_static_class")));
	...
	if(base_class)
	{
		lualist(obj_fields)assignwith(
		{
		});
		local(lualist(curClass)assignwith(class));
		while(nil ~= curClass)
		{
			if(warmup(curClass))
			{
				local(lualist(ofs)assignwith(rawget(curClass, "__obj_fields")));
				if(ofs)
				{
					for(k, v)
					in(pairs(ofs))
	...
	{
		rawset(obj_meta, "__index", function()
		luaargs(t, k)
		{
			if(obj_fields)
			{
	...
	if(base_class)
	{
		...
		rawset(class, "__newindex", function()
		luaargs(t, k, v)
		{
			if(class_fields)
			{
				local(lualist(ret)assignwith(class_fields[k]));
				if(nil ~= ret)
				{
					rawset(t, k, v);
					return();
...
luaargs(class, typeargs, typekinds, ctor, ctorRetCt, initializer, ...)
{
	local(lualist(obj)assignwith(nil));
	local(lualist(arg1, arg2)assignwith(...));
	if(class == System.Nullable_T)
	{
		return(nil);
